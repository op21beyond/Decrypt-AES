...
//               - Always responds OKAY (no error injection from memory side)
...
module fake_mem #(
            ...
            case (wr_state)
                ...
                WR_DATA: begin
                    if (s_wvalid && s_wready) begin
                        // Apply byte strobes to the word
    ...
    // -------------------------------------------------------------------------
    // Backdoor read task — used by testbench to verify output buffer contents
    // -------------------------------------------------------------------------
